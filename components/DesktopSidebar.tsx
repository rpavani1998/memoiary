    ...
    <aside className="hidden md:flex flex-col justify-between w-64 h-screen sticky top-0 bg-[#F5F1E8] border-r-[1.5px] border-[#1C1917] p-6 shrink-0 font-sans">
      <div className="space-y-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-serif text-2xl font-medium text-[#1C1917] leading-none">
              Memoiary
            </h1>
            <p className="text-[10px] text-[#665F56] font-sans mt-1 tracking-wider uppercase font-semibold">
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3.5 px-4 py-3 rounded-2xl text-sm font-semibold transition-all cursor-pointer ${
                  isActive
                    ? "bg-[#F5E5DC] text-[#DE5239] border-[1.5px] border-[#1C1917] shadow-xs"
                    : "text-[#1C1917]/80 hover:text-[#1C1917] hover:bg-[#FBF9F4] border border-transparent"
                }`}
              >
                <span className={isActive ? "text-[#DE5239]" : "text-[#665F56]"}>
                  {link.icon}
                </span>
