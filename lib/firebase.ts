...
const firebaseConfig = {
  ...
  apiKey: process.env.NEXT_PUBLIC_FIREBASE_API_KEY || process.env.FIREBASE_API_KEY || (localConfig.apiKey && localConfig.apiKey !== "YOUR_FIREBASE_API_KEY" ? localConfig.apiKey : null) || "AIzaSyDPdnip1YIn3ZL-POrzRiSrSZ3h6Nd9KFQ",
